...
└── overlays/
    ├── dev/
    │   ├── kustomization.yaml     # aggregator (generated by IssueOps)
    │   ├── dind/                  # straw-hat-runners-linux-dev-dind
    │   ├── kubernetes/            # straw-hat-runners-linux-dev-kubernetes
    │   └── gpu/                   # straw-hat-runners-linux-dev-gpu
    └── prod/
        ├── kustomization.yaml
        ├── dind/                  # straw-hat-runners-linux-prod-dind
        └── kubernetes/            # straw-hat-runners-linux-prod-kubernetes
```
